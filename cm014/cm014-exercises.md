...
![](cm014-exercises_files/figure-gfm/unnamed-chunk-2-1.png)<!-- -->
...
![](cm014-exercises_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
...
data frame). ~ to predict left using variables in the right side.
...
(default is to use fitting/training data). Here are the
predictions:
...
![](cm014-exercises_files/figure-gfm/unnamed-chunk-7-1.png)<!-- -->
